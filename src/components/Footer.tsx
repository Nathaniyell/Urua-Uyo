...
const Footer = () => {
  return (
    <footer className="w-100 p-3 p-md-3" style={{backgroundColor: "#552d1ed9"}}>
    <Row xs={1} md={3} className="text-white justify-content-between mb-5">
        ...
        <form action="" className="my-3 my-md-0">
            ...
            <div>
                <input className="footer__input mb-2 w-100" type="email" placeholder="johndoe@email.com" />
                <button className="footer-btn w-100" type="submit">Submit</button>
            </div>
        </form>
        </Col>
    ...
    <div className="d-flex flex-md-row align-items-center">
        {
            [mastercard, visa, verve].map((icon, index)=>{
                return(
                    ...
                    style={{width: "25%"}}  className="mx-auto" key={index} />
                )
            })
        }
    </div>
